...
import { Laptop, Code2, Sparkles } from "lucide-react";
import AOS from "aos";
          ...
          <div className="relative min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-4xl mx-auto">
              ...
              <motion.div className="flex justify-center gap-6 mb-10">
                {[Laptop, Code2, Sparkles].map((Icon, index) => (
                  <div
                    key={index}
                    data-aos="fade-down"
              ...
              <motion.div className="text-center mb-10">
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold space-y-3">
                  <div>
                    ...
                    >
                      Hi, I’m Habibullah Kharis Pramudita
                    </span>
                  </div>
                  <div>
                    <span
                ...
                >
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    ...
                    <span className="bg-gradient-to-r from-sky-700 to-blue-800 bg-clip-text text-transparent">
                      <TypewriterEffect text="Enter Portfolio" />
                    </span>
                  </div>
                </button>
              </motion.div>
